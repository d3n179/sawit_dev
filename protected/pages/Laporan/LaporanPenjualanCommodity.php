...
class LaporanPenjualanCommodity extends MainConf
{
	...
	public function cetakLaporanTimbangan($sender,$param)
	{
		...
		$session['cetakLapPenjualanCommoditySql'] = $this->getViewState('sql');
				...
				$url = "index.php?page=Laporan.cetakLaporanPenjualanCommodityPdf&periode=".$this->Periode->SelectedValue."&bln=".$this->DDBulan->SelectedValue."&thn=".$this->DDTahun->SelectedValue."&mingguan=".$this->mingguan->Text."&harian=".$this->harian->Text;
