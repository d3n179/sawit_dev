...
class cetakMultiSlipGajiPdf extends MainConf
{
...
$html = '</br></br><table width="100%" cellpadding="0">
		  <tr>
			<td align="center" style="font-size:25px"><b>PT. SINAR HALOMOAN</b></td>
		  </tr>
		  <tr>
			<td align="center" style="font-size:20px"><b>KANTOR DIREKSI PASIR JAE</b></td>
		  </tr>
		  <tr>
			<td align="center" style="font-size:20px"><b>DEPARTEMEN ADMINISTRASI, KEUANGAN DAN SDM</b></td>
		  </tr>
		  <tr>
...
$html = '<table width="100%" cellpadding="0" border="0">
		  ...
		  <tr>
			<td align="center" style="font-size:20px;"><b style="text-decoration: underline;">PUTRA MAHKOTA ALAM HASIBUAN, SE </b><br/><i><strong>DIREKTUR UTAMA</strong></i></td>
			<td></td>
