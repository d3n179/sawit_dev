...
class cetakDeliveryOrderPdf extends MainConf
{
...
$html = '</br><table width="100%" cellpadding="2">
		  <tr>
			<td align="center" style="font-size:35px;text-decoration: underline;"><b>DELIVERY ORDER</b></td>
		  </tr>
		</table>
		<br>
		<table width="100%" cellpadding="2" style="font-size:9pt;">
		   <tr>
			...
			<td align="left" width="60%">'.$record->no_do.'</td>
		  </tr>
		   <tr>
			<td align="left"></td>
			<td align="left"></td>
		  ...
		  <tr>
			...
			<td align="left">:</td>
			<td align="left"><b>MILL MANAGER</b></td>
		  </tr>
		  <tr>
		...
		<table width="100%" cellpadding="2" style="font-size:9pt;">
		   <tr>
			<td align="left">Demikian disampaikan untuk dilaksanakanb dan terima kasih</td>
		  </tr>
		</table>
		<br>
		<table width="100%" cellpadding="2" style="font-size:9pt;">
		...
		<table width="100%" cellpadding="2" style="font-size:9pt;">
		   <tr>
			...
			<td align="left">- Pembeli <br>- Finance Department <br>- File</td>
		  </tr>
		 </table>';
$pdf->writeHTML($html, true, false, true, false, '');
$pdf->Ln(1);
